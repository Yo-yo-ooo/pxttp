...
{
	cons_putstr0(cons, "'HLP[HLP,1,2,3]'\nShow Command.\n");
	...
	}else if (strcmp(cmdline, "HLP") == 0) {
		cons_putstr0(cons,"1. *.hrb Open this system \n progamming file.\n");
		cons_putstr0(cons,"2.'tview'\n3.'mmlplay[*.mml]'\n4.'gview[Picture File]'\n5.'mem','exit','cls'\n6.'start cmd','langmode '\n");
	}else if (strcmp(cmdline, "HLP2") == 0) {
		cons_putstr0(cons,"7.'invader','lines','noodle'\n8.'star[1,s]''winhelo[2,3]'.\n");
	}else if (strcmp(cmdline, "HLP3") == 0) {
		cons_putstr0(cons,"8.'ncst [*.hrb]\n'");
	}else if (cmdline[0] != 0) {
